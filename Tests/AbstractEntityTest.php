...
abstract class AbstractEntityTest extends KernelTestCase
{
    ...
    public function getMockOfferAttribute($name, $content)
    {
     ...
     */
    public function getMockCategory()
    {
        ...
        $category2->expects($this->any())->method('getChildren')->willReturn([$category3]);
        $category1->expects($this->any())->method('getChildren')->willReturn([$category2, $category3]);

        return $category3;
    }

    public function getMockCategoryTranslations($name = 'unit_test')
    {
    ...
    public function getMockOfferDescriptions()
    {
        $offerDescriptions = [];
        foreach (Offer::SUPPORTED_LOCALES as $locale) {
    ...
    public function getMockOfferImages()
    {
        $offerImages = [];
        for ($i = 0; $i <= 5; $i++) {
     ...
     * @return ExchangeRate
     */
    public function getMockExchangeRate($currency = 'EUR', $rate = 1.0)
    {
